...
func data_load():
	...
	setting_volume_music = config.get_value(
		"settings", "setting_volume_music", default_volume_music
	)

	setting_music_enabled = config.get_value(
		"settings", "setting_music_enabled", default_music_enabled
	)
